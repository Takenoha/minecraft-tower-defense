...
public final class TacticalDefinitionCodec {
    private static final String JSON_PREFIX = "{\"format\":\"tdb1\",\"payload\":\"";
    ...
    public static String encode(TacticalBuildDefinition definition) {
        try {
            ...
            return JSON_PREFIX + payload + JSON_SUFFIX;
    ...
    private static void writeDefinition(
            ...
            TacticalBuildDefinition definition) throws IOException {
    ...
    private static TacticalBuildDefinition readDefinition(DataInputStream input) throws IOException {
        ...
        for (int index = 0; index < nodeCount; index++) {
            ...
            nodes.add(new TacticalSkillNodeDefinition(
                    nodeId, nodeVersion, tier, nodeName, nodeDescription, effects));
        }
