...
- Core item recipe templates, unbound/bound identity creation, `ITEM_VERSION`, material checks, amount-one reads, Optional identity parsing, and item-id matching retain their Java-facing behavior.
...
The clean verification build completed successfully at verified code HEAD `bea29c907bb43fc5705cab9fb3bcfb0f2fbb70af`:
...
- packaged JAR SHA-256: `7CAFE45BFB915FFB073A12083D8DA8F7C656C9CF9D686EFF281DB5F12FEAB143`
