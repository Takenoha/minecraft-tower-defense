...
- Verified code HEAD: `acb045d16b89d5250fcf0781bf1ae62894bb290c`.
...
- `TowerRecipeCatalog.keys()` and `RaidSealCatalog.recipeStages()` return unmodifiable lists, preserving the Java `List.copyOf`/`Stream.toList` contract.
...
- Result: `BUILD SUCCESSFUL`; 99 XML test suites, 329 tests, failures 0, errors 0, skipped 0.
- Fat JAR SHA-256: `29AE9BF47F50B763C63A088389A5A06BE7CBE334AF0368FE1CDD79EF86E7DA86`.
